...
Используется БЕСПЛАТНАЯ модель mistralai/mistral-small-3.1-24b-instruct:free (24B параметров)
"""
...
def main():
    ...
    print("   (БЕСПЛАТНАЯ МОДЕЛЬ MISTRAL SMALL 3.1 - 24B)")
    print("="*60)
    ...
    4. Бесплатная модель Mistral Small 3.1 от OpenRouter отлично работает!
